...
import redTravelIcon from '../../assets/static/travel-icon.png';
import BlueTravelIcon from '../../assets/static/blue-travel-icon.png';
...
const TravelIcon =
  insuranceCompany === 'OCEANICA' ? BlueTravelIcon : redTravelIcon;
  ...
  return (
    <View style={styles.cardInfo}>
      ...
      <View style={styles.rowDataIcon}>
        ...
        <Text style={styles.quotationInfo}>
          Destino: {budgetInfo.desc_destination_region}
        </Text>
      </View>
      <View style={styles.rowDataIcon}>
        <Text style={styles.quotationInfo}>
          Duración: {budgetInfo.days_travel} Dias
        </Text>
      </View>
      <View style={styles.rowDate}>
        <Text
          style={styles.cobertInfoCard}
