...
import redPeopleIcon from '../../assets/static/people-icon.png';
import BluePeopleIcon from '../../assets/static/blue-people-icon.png';
...
const peopleIcon =
  insuranceCompany === 'OCEANICA' ? BluePeopleIcon : redPeopleIcon;
